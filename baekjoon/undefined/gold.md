...
2. [Min Heap 자료구조](https://sois-organization.gitbook.io/today-i-learned/undefined/heap)를 만든다. (Swift는 heap 자료구조를 제공하지 않는다.)
3. 다익스트라 알고리즘을 수행한다.
...
[문제로 이동](https://www.acmicpc.net/problem/7576)
